...
then
    ...
    then
      ...
      curl -X 'POST' 'http://zlifecycle-api.zlifecycle-ui.svc.cluster.local/costing/saveComponent' -H 'accept: */*' -H 'Content-Type: application/json' -d '{"teamName": "'$team_name'", "environmentName": "'$env_name'", "component": { "componentName": "'$config_name'", "cost": '$estimated_cost' }}'
