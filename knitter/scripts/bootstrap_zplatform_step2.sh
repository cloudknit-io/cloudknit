...
argocd app create dev --repo git@github.com:CompuZest/infra-deploy-terraform-config.git --path 1-dev --dest-server https://kubernetes.default.svc --dest-namespace default --directory-recurse  --sync-policy automated --auto-prune
