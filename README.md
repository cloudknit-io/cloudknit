...
CloudKnit is based on a concept called [Environment as Code](https://docs.cloudknit.io/concepts/concepts/#environment-as-code). Some people have started calling it Declarative Pipelines.
