...
export const Popup = (props: PopupProps) => (
	<div className="popup-overlay">
		<div className="popup-container">
			<div
				className={`row popup-container__header ${
					props.titleColor !== undefined
						? 'popup-container__header__' + props.titleColor
						: 'popup-container__header__normal'
				}`}>
				{props.title}
			</div>
			<div className="row popup-container__body">
				...
				<div
					className={classNames(
						'columns',
						{ 'large-10': !!props.icon, 'large-12': !props.icon },
						!props.icon && 'popup-container__body__hasNoIcon'
					)}>
			...
			<div
				className={classNames('row popup-container__footer', {
					'popup-container__footer--additional-padding': !!props.icon,
				})}>
				{props.footer}
			</div>
		</div>
