...
import ReactForm, { FormField } from 'react-form';

import { Autocomplete, AutocompleteOption, AutocompleteProps } from './autocomplete';

export const AutocompleteField = FormField(
	(props: AutocompleteProps & { fieldApi: ReactForm.FieldApi; className?: string }) => {
		const {
	...
	ReactForm.FieldProps & { items: (AutocompleteOption | string)[]; className?: string; filterSuggestions?: boolean }
>;
