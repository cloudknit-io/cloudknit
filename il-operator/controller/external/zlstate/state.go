...
//go:generate mockgen --build_flags=--mod=mod -destination=./mock_state_manager.go -package=zlstate "github.com/compuzest/zlifecycle-il-operator/controller/external/zlstate" API
type API interface {
