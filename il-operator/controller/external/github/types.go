...
//go:generate mockgen --build_flags=--mod=mod -destination=./mock_github_api.go -package=github "github.com/compuzest/zlifecycle-il-operator/controller/external/github" API
type API interface {
