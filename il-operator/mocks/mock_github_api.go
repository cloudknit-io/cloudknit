...
// Source: github.com/compuzest/zlifecycle-il-operator/controllers/util/github (interfaces: GitAPI,RepositoryAPI,AppAPI)
...
func (m *MockAppAPI) FindRepositoryInstallation(arg0, arg1 string) (*github.Installation, *github.Response, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAppAPIMockRecorder) FindRepositoryInstallation(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindRepositoryInstallation", reflect.TypeOf((*MockAppAPI)(nil).FindRepositoryInstallation), arg0, arg1)
}
