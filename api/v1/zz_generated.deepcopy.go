...
func (in *EnvironmentStatus) DeepCopyInto(out *EnvironmentStatus) {
	*out = *in
	...
	if in.TfvarsState != nil {
		in, out := &in.TfvarsState, &out.TfvarsState
		*out = make(map[string]map[string]*Tfvars, len(*in))
		for key, val := range *in {
			var outVal map[string]*Tfvars
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make(map[string]*Tfvars, len(*in))
				for key, val := range *in {
					var outVal *Tfvars
					if val == nil {
						(*out)[key] = nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Tfvars) DeepCopyInto(out *Tfvars) {
	*out = *in
	in.ReconciledAt.DeepCopyInto(&out.ReconciledAt)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Tfvars.
func (in *Tfvars) DeepCopy() *Tfvars {
	if in == nil {
		return nil
	}
	out := new(Tfvars)
