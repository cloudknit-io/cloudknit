...
func GetCustomerTerraformStateConfig(ctx context.Context, client API, meta *secret.Identifier, log *logrus.Entry) (*TerraformStateConfig, error) {
...
func GetAWSCredentials(ctx context.Context, client API, meta *secret.Identifier, log *logrus.Entry) (*AWSCredentials, error) {
