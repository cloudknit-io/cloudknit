...
//go:generate mockgen --build_flags=--mod=mod -destination=./mock_git_api.go -package=git "github.com/compuzest/zlifecycle-il-operator/controller/external/git" PI
type API interface {
