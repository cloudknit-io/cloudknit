...
import (
	...
	notifier2 "github.com/compuzest/zlifecycle-il-operator/controller/external/notifier"
...
func (u *UINotifier) Notify(ctx context.Context, n *notifier2.Notification) error {
