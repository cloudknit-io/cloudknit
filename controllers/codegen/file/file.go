...
//go:generate mockgen --build_flags=--mod=mod -destination=./mock_file.go -package=file "github.com/compuzest/zlifecycle-il-operator/controllers/codegen/file" API
type API interface {
