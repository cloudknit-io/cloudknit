...
//go:generate mockgen --build_flags=--mod=mod -destination=./mock_watcher_api.go -package=watcher "github.com/compuzest/zlifecycle-il-operator/controllers/watcher" Watcher
type API interface {
