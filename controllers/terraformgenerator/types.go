...
type UtilTerraformGenerator interface {
	...
	GenerateFromTemplate(vars interface{}, environmentComponentDirectory string, componentName string, fileUtil file.API, templateName string, filePath string) error
}
